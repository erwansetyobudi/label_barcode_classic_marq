...
$html_str .= '</div>';
       ...
       if($sysconf[$plugin_name]['barcode_include_header_text']=='1'){
            ...
            // Split callnumber menjadi 2 baris berdasarkan spasi pertama
$call_parts = explode(' ', $callnumb, 2);
$call_line1 = $call_parts[0];
$call_line2 = isset($call_parts[1]) ? $call_parts[1] : '';
...
$line1 = substr($classification, 0, 1);                 // digit ke-1
$line2 = substr($classification, 1, 1);                 // digit ke-2
$line3 = substr($classification, 2, 1) . '.';           // digit ke-3 + titik
$line4 = substr($classification, 4, 1);                 // digit pertama setelah titik
